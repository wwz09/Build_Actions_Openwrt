...
#修改默认无线名称
sed -i 's/LEDE/CM520A-2.4G/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
...
# 修改输出文件名
# sed -i 's/IMG_PREFIX:=$(VERSION_DIST_SANITIZED)/IMG_PREFIX:=KYT-$(shell date +%Y%m%d)-CM520/g' include/image.mk
